/**
 * Dashboard View
 * Leverer HTML-strukturen til landingpagen
 */
export function renderDashboard(container) {
    ...
    // Her kan vi senere tilføje kald til Firestore for at udfylde "preview" felterne
    loadDashboardData();
}

function loadDashboardData() {
    // Denne funktion vil blive udbygget i takt med at vi bygger de andre moduler
